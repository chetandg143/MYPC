...
public class Base {
	...
	/*	cap.setCapability(MobileCapabilityType.DEVICE_NAME,"Chetan");
		...
		cap.setCapability(MobileCapabilityType.PLATFORM_VERSION, "7.0");
		cap.setCapability(MobileCapabilityType.PLATFORM_NAME, "Android");
		cap.setCapability(AndroidMobileCapabilityType.APP_ACTIVITY, "com.android.calendar.AllnOneActivity");
		cap.setCapability(AndroidMobileCapabilityType.APP_PACKAGE, "com.android.calendar");
		cap.setCapability(MobileCapabilityType.AUTOMATION_NAME, "appium");
		URL u = new URL("http://0.0.0.0:4723/wd/hub");
		AndroidDriver<MobileElement> driver = new AndroidDriver<>(u, cap);
		return driver;*/
